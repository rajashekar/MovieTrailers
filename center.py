"""Create movie objects and
calls fresh_tomatoes.open_movies_page to generate html
"""
import media
...
EVERYTHINGISILLUMINATED = media.Movie("Everything Is Illuminated",
                                      "Leave Normal Behind.",
                                      "https://upload.wikimedia.org/wikipedia/en/2/27/Everything_Is_Illuminated_film.jpg",  # noqa
                                      "https://www.youtube.com/watch?v=l-hCtlNM32M")  # noqa
...
MOVIES = [TOY_STORY, AVATAR, FIGHTCLUB,
          VFORVENDETTA, EVERYTHINGISILLUMINATED, CONTACT]
